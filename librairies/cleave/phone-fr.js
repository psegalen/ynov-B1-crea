...
*/
  ...
  function F(n) {
    for (var t = n.f.length, e = 0; e < t; ++e) {
      ...
      if (a)
        return (n.w = i), (n.B = pn.test(h(l, 4))), (n.s = 0), !0;
    }
    return (n.l = !1);
  }
  function B(n, t) {
    for (
      var e = [], r = t.length - 3, l = n.f.length, i = 0;
      i < l;
      ++i
    ) {
      var a = n.f[i];
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return (
        B(n, t),
        (t = D(n)),
        0 < t.length ? t : F(n) ? G(n) : n.i.toString()
      );
    }
    return M(n, t);
  }
